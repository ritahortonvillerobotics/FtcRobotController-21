...
//import hortonvillerobotics.FinalRobotConfiguration;
    ...
    @Autonomous(name = "org.firstinspires.ftc.teamcode.Red1_2", group = "Autonomous")
//
    public class Red1_2 extends LinearOpMode {
     ...
     int count = 0;*/
        ...
        public void runOpMode() throws InterruptedException {
            ...
            sleep(2000);
            r.arm(1, 300);
            r.driveForwardTimed(.1, 1700);
            sleep(2000);
            r.turnRightTimed(.55, 950);
            sleep(2000);
            ...
            sleep(300);
            r.turnLeftTimed(.55, 900);
            sleep(1000);
            r.driveForwardTimed(.1, 880);
            r.turnRightTimed(.35, 460);
